...
class Produto(models.Model):
    ...
    situacao = models.ForeignKey(StatusProduto, on_delete=models.PROTECT, related_name="categoria_produto", verbose_name="Situação")
    categoria = models.ForeignKey(CategoriaProduto, on_delete=models.PROTECT, related_name="categoria_produto", blank=True, null=True)    
...
class Endereco(models.Model):
    ...
    referencia = models.CharField(max_length=50, verbose_name="Ponto de Referência", blank=True, null=True)
